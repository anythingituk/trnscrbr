...
public sealed class SettingsImportExportService
{
    ...
    private static AppSettings Clone(AppSettings settings)
    {
        ...
        return new AppSettings
        {
            ...
            AutoLanguageHintApplied = settings.AutoLanguageHintApplied,
            CaptureStartupBufferMilliseconds = settings.CaptureStartupBufferMilliseconds,
            AutoEnglishDictationCount = settings.AutoEnglishDictationCount,
            ...
            LocalWhisperCliVersion = settings.LocalWhisperCliVersion,
